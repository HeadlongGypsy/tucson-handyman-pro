    ...
    <section className="relative pt-16 h-[38vh] min-h-[280px] overflow-hidden">
      ...
      <div className="relative z-10 h-full flex flex-col justify-center px-8 md:px-16 lg:px-24 max-w-4xl">
        ...
        <a
          ...
          className="self-start bg-accent text-accent-foreground px-7 py-3 text-sm font-medium tracking-wide hover:opacity-90 transition-opacity duration-200"
        >
  ...
  return (
    <>
      ...
      <div className="max-w-7xl mx-auto px-8 md:px-16 lg:px-24 py-8">
        <a
          href="tel:+15206009872"
          className="inline-block bg-accent text-accent-foreground px-7 py-3 text-sm font-medium tracking-wide hover:opacity-90 transition-opacity"
        >
          Schedule an Assessment
        </a>
      </div>
